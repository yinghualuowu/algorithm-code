...
2. 打开 SQL Editor：
   ...
   - 已执行过初始 migration 的项目，再执行 [`supabase/migrations/20260723_add_schema_comments.sql`](supabase/migrations/20260723_add_schema_comments.sql) 补充表字段说明。
